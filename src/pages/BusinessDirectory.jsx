...
export default function BusinessDirectory() {
    ...
    useEffect(() => {
        axios.get('/api/business').then(res => {
            ...
            // Mock if empty
            const mock = [
                { id: 1, name: 'Güneyyurt Lezzet Sofrası', category: 'Restoran & Kafe', description: 'Geleneksel lezzetlerin modern sunumuyla buluştuğu nokta.', address: 'Belediye Cd. No:12', phone: '0338 736 00 00', website: '', workingHours: '08:00 - 22:00', isFeatured: true, logoUrl: 'https://images.unsplash.com/photo-1517248135467-4c7ed9d8747c?w=400' },
