...
const serviceLinks = [
  ...
  { name: 'Kent Rehberi', icon: PhotoIcon, color: 'bg-slate-900', href: '/hizmetler/rehber' },
  { name: 'Belediye İştirakleri', icon: BriefcaseIcon, color: 'bg-indigo-600', href: '/kurumsal/isletmeler' },
